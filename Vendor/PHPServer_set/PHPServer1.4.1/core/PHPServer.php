...
class PHPServer
{
    ...
    protected static function forkOneWorker($worker_name)
    {
        ...
        elseif($pid === 0)
        {
            ...
            // 创建worker实例
            $worker = new $class_name(isset(self::$listenedSockets[$worker_name]) ? self::$listenedSockets[$worker_name] : null, $recv_timeout, $process_timeout, $send_timeout, $persistent_connection, $max_requests, self::$projectName, $max_work_time);
            // 设置服务名
