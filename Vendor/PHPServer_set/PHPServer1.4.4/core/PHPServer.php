 ...
 * 发布日期: 2016-01-05 
 * 特性更新:
 *       修正当HTTP客户端提交的数据较大时，数据读取不完整的问题。
 * 版本：1.2.3
 * 发布日期：2015-09-24
 * 特性更新：
 * 2015-09-24 配额重构+大促看板之失败qps统计上报+大促看板之错误日志分类上报+1984端口close_wait修复+主进程退出误告警修复+远程telnet连接被关闭问题修复+修复信号打断select导致误判连接断开+调用来源用户上报超出udp包大小限制修复+qps上报udp包被截断+修复QuotaAgent reload status=-9错误(疯了，上个版本问题咋这么多...- -!)
 ...
 * 2014-05-12 $killWorkerTimeLong 改回到原来的4秒
 * 
 * PHPServer
