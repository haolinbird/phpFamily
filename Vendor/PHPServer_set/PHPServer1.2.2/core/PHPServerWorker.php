...
class PHPServerWorker
{
     ...
     */
    public function __construct($socket = null, $recv_timeout = 1000, $process_timeout = 30000, $send_timeout = 1000, $persistent_connection = false, $max_requests = 0, $project_name = '')
    {
        // 初始化
