 ...
 * 
 */
require_once SERVER_BASE.'/Vendor/Thrift/Lib/Thrift/ClassLoader/ThriftClassLoader.php';
use Thrift\ClassLoader\ThriftClassLoader;

$loader = new ThriftClassLoader();
$loader->registerNamespace('Thrift', SERVER_BASE . 'Vendor/Thrift/Lib/');
$loader->register();
...
class ThriftWorker extends PHPServerWorker
{
    ...
    {
        $this->disableLark = PHPServerConfig::get('workers.'.$this->serviceName.'.disable_lark') === true;
    ...
    protected function send($data) {
        ...
        if(!$this->disableLark){
            $encode_text = Lark::encode(Lark::TAG_RPC_SERVER_SEND, array($encode_text));
        }
    ...
    public function dealThriftProcess($recv_str) {
        ...
        $method_name = 'none';
        // 来源ip
        $source_ip = self::$currentClientIp;
        // 尝试读取上下文信息
        try{
            // 去掉TFrameTransport头
            ...
            if (\Thrift\Context::get('isHeartBeat')=='true'){
                ...
                $framedTrans->setTag(\Lark::TAG_RPC_SERVER_SEND);
