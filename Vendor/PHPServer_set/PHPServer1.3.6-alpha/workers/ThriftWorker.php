...
class ThriftWorker extends PHPServerWorker
{
    ...
    protected function process($data)
    {
        ...
        self::$traceStr = empty($data['traceStr']) ? '' : $data['traceStr'];

        $this->startTingYunAction(self::$currentModule, self::$currentInterface, self::$traceStr);
    ...
    public function dealThriftProcess($recv_str) {
        ...
        else
      {
        ...
        self::$traceStr = \Thrift\Context::get('traceStr');
