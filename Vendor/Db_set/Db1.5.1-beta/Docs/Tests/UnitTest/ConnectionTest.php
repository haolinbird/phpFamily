...
class ConnectionTest extends  \PHPUnit_Framework_TestCase{
    ...
    public function cfgData()
    {
        return array(
            // 第一组数据(来自配置系统)：需要被解析
            // ps. dataprovier is supposed to supply params for test function. array items are ranged as param for function
            array(
                array(
                    'dsn'      => 'mysql:dbname=tuanmei_operation;host=192.168.20.71:9001:2,192.168.20.72:9001:1',
                    'user'     => 'dev',
                    'password' => 'jmdevcd',
                ...
                array(
                    array(
                        'dsn'      => 'mysql:dbname=tuanmei_operation;host=192.168.20.71;port=9001',
                        'db' => 'tuanmei_operation',
                        'weight' => '2',
                        'host'  => '192.168.20.71',
                        'port' => '9001',
                        'user'     => 'dev',
