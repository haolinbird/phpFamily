...
class JMImageClient {
    ...
    public function getFile($bucket, $file) {
        ...
        $response = JMRestHttp::httpRequest('GET', $url);
    ...
    public function setFile($bucket, $file, $content, $contentType) {
        ...
        $response = JMRestHttp::httpRequest('PUT', $url, $this->endpoint['auth'],$this->buildRequestHeads($headers), $content);
        return $this->parseBody($response);
    ...
    public function copyFile($bucket, $sourceBucket, $file) {
        ...
        $response = JMRestHttp::httpRequest('PUT', $url, $this->endpoint['auth'], $this->buildRequestHeads($headers));
        return $this->parseBody($response);
    ...
    public function deleteFile($bucket, $file) {
        ...
        $url = $this->buildRestPath($bucket, $file);
        $response = JMRestHttp::httpRequest('DELETE', $url, $this->endpoint['auth']);
        return $this->parseBody($response);
