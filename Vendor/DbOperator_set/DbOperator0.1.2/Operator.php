...
class Operator
{
    ...
    public function operator()
    {
        ...
        if ($this->dbConfigName) {
            $instance = $this->partition ? \Db\Connection::instance()->partitionByUID($this->partition) : \Db\Connection::instance();
            if ($this->master) {
                $db = $this->db = $instance->write($this->dbConfigName);
            } else {
                $db = $this->db = $instance->read($this->dbConfigName);
            }
